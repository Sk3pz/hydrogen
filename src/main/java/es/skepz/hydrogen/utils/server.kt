...
fun setWarp(plugin: Core, name: String, loc: Location) {
...
fun getWarp(plugin: Core, name: String): Location? {
...
fun setSpawn(plugin: Core, loc: Location) {
    val data = plugin.files.data
